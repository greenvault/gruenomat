            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><strong>Anscheinend hast du keine Fragen beantwortet.</strong><br/>
                        Entweder hast du diese Seite direkt aufgerufen, oder du hast die Thesen noch nicht bearbeitet.
                    </p>
...
<div class="container mow-container" style="margin-top: 20px;">
    ...
    <div class="bottom-buffer top-buffer">
        ...
        <table class="table table-bordered">
            <tr>
                <th style="width: 320px;">Deine Wahl</th>
                <th>Doppelt gewichten</th>
                <?php
        ...
        <div class="text-right">
            ...
            <small>Du kannst die Befragung
                ...
                oder deine
                <a href="mahlowat.php"
                   onclick="callPage(event, 'mahlowat.php', array2str(getResultArray()), <?php echo "'$count'"; ?>)"
                   title="Antworten ändern">Antworten ändern</a>.<br/>
                Außerdem haben wir auch eine <a href="faq.php?from=multiplier.php"
                                                onclick="callPage(event, 'faq.php?from=multiplier.php', array2str(getResultArray()), <?php echo "'$count'"; ?>)"
                                                title="FAQ">FAQ-Seite</a>.
            </small>
        </div>
    </div>
</div>
